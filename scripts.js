...
console.log(`The result is ${result}`); // Output: 42
...
console.log(`The average age is ${average}`); // Output: ~32.4286
...
let average2 = sum2 / names.length; // average length of words in array is calculated
console.log(`The average length of letters is ${average2}`); // Output: ~3.833
...
console.log(`All the names: ${concatenated}`); // Output: Sam Tommy Tim Sally Buck Bob
...
console.log(`Length of each name: ${nameLengths}`); // Output: 3 5 3 5 4 3
...
console.log(`Sum of all the elements: ${sum3}`); // Output: 23
...
console.log(`Word repeat: ${repeatWord('Hello', 7)}`); // calls the function and outputs 'Hello' seven times.
...
console.log(`Full name: ${fullName('John', 'Deer')}`); // calls the function and outputs the names combined.
...
console.log(`True if greater than 100: ${isGreaterThan100(testNumbers)}`); // calls the function and returns false because the sum is less than 100.
...
console.log(`Average of all elements: ${findAverage(testNumbers)}`); // Output: 23.75
...
console.log(`True if firstAverage > secondAverage: averageCheck(testNumbers, testNumbers2)`) // Returns true
...
console.log(`True if we have more than 10.50 and is hot outside: ${willBuyDrink(true, 10)}`); // Outputs false because 10 is less than 10.50
...
console.log(`Largest number: ${maximumNumber(testNumbers)}`);
